import { footer, security } from "@/lib/content";
          ...
          <div className="text-sm text-muted space-y-3">
            ...
            <div className="flex gap-2 flex-wrap">
              {security.badges.map((b) => (
                <span
                  key={b}
                  className="text-[9px] font-semibold tracking-wide text-muted border border-line rounded-full px-2.5 py-1"
                >
                  {b}
                </span>
              ))}
      ...
      <ul className="mt-3 space-y-2">
        {links.map((l) => (
          <li key={l.label}>
            <a
              href={l.href}
              className="text-sm text-muted hover:text-ink focus-visible:outline-2 focus-visible:outline-accent rounded"
            >
              {l.label}
            </a>
          </li>
